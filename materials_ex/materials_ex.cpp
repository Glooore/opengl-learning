...
int main(int argc, char** argv)
{
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		float light_z = sin(current_frame) * 1.5f;

		glm::vec3 light_position = glm::vec3(light_x, light_y, light_z);
		...
		model = glm::rotate(model, (float)current_frame, glm::vec3(0.f, 1.0f, 0.0f));
