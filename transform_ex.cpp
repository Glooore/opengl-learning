...
int main()
{
	...
	Shader ourShader("shaders/transform.vert", "shaders/transform.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float sin_scale = sin(3.14 * glfwGetTime());
		trans = glm::scale(trans, glm::vec3(sin_scale, sin_scale, 1.0));
		glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
